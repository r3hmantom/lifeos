...
| Code | Description | Schema |
| ---- | ----------- | ------ |
| 200 | List of timetable slots | **application/json**: [TimetableTemplateResponse](#timetabletemplateresponse)<br> |
...
| Required | Schema |
| -------- | ------ |
|  Yes | **application/json**: { **"time"**: string, **"activity"**: string, **"isActive"**: boolean }<br> |

#### Responses

| Code | Description | Schema |
| ---- | ----------- | ------ |
| 200 | Created timetable slot | **application/json**: [TimetableSlot](#timetableslot)<br> |
...
| Code | Description | Schema |
| ---- | ----------- | ------ |
| 200 | Updated timetable slot | **application/json**: [TimetableSlot](#timetableslot)<br> |
| 404 | Slot not found |  |
...
| Code | Description | Schema |
| ---- | ----------- | ------ |
| 200 | Slot deleted | **application/json**: { **"message"**: string }<br> |
| 404 | Slot not found |  |
...
| Name | Type | Description | Required |
| ---- | ---- | ----------- | -------- |
| data | [ [TimetableSlot](#timetableslot) ] |  | No |
